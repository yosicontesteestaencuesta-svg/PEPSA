...
st.markdown("""
    <style>
    .stApp { background-color: #FFFFFF; color: #1F4E78; }
    h1, h2, h3, h4, h5, h6, label, p, span, div { color: #1F4E78 !important; }
    div[data-baseweb="checkbox"] span:first-child { border-color: #1F4E78 !important; }
    div[data-baseweb="checkbox"] [aria-checked="true"] { background-color: #28A745 !important; border-color: #28A745 !important; }
    .stTextInput input, .stNumberInput input, .stSelectbox div[data-baseweb="select"], .stTextArea textarea {
        background-color: #F8F9FA !important; color: #1F4E78 !important; border: 1px solid #1F4E78 !important;
    }
    .paro-box { background-color: #E8F4F8; border-left: 5px solid #1F4E78; padding: 15px; border-radius: 5px; margin-bottom: 15px; }
    </style>
""", unsafe_allow_html=True)

# Clase FPDF con codificación limpia
class PDF(FPDF):
    def header(self):
...
def generar_pdf_completo(reg):
    ...
    # 3. Herramental y Criterios de Paro
